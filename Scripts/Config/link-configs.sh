...
configs=(
  "$HOME/iterami/repos/EVE-Overviews.yaml/yaml/iterami-overview.yaml"
  "$HOME/iterami/repos/files/Config/Crysis/diff_bauer.cfg"
  "$HOME/iterami/repos/files/Config/GarrysMod/autoexec.cfg"
  "$HOME/iterami/repos/files/Config/Gothic/3/ge3.ini"
  "$HOME/iterami/repos/files/Config/Half-Life/2/autoexec.cfg"
  "$HOME/iterami/repos/files/Config/Half-Life/2-1/autoexec.cfg"
  "$HOME/iterami/repos/files/Config/Half-Life/2-2/autoexec.cfg"
  "$HOME/iterami/repos/files/Config/Half-Life/Lost-Coast/autoexec.cfg"
  "$HOME/iterami/repos/files/Config/Might-and-Magic/Dark-Messiah/autoexec.cfg"
  "$HOME/iterami/repos/files/Config/Portal/1/autoexec.cfg"
  "$HOME/iterami/repos/files/Config/Portal/2/autoexec.cfg"
  "$HOME/iterami/repos/files/Config/Team-Fortress-2/autoexec.cfg"
  "$HOME/iterami/repos/files/Config/The-Stanley-Parable/autoexec.cfg"
  "$HOME/iterami/repos/files/Config/The-Stanley-Parable-Demo/autoexec.cfg"
  "$HOME/iterami/repos/files/Config/Thief/3-Deadly-Shadows/System/Default.ini"
  "$HOME/iterami/repos/files/Config/Thief/3-Deadly-Shadows/System/T3UI.ini"
  "$HOME/iterami/repos/files/Config/Thief/3-Deadly-Shadows/options.ini"
)
