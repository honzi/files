...
configs=(
  ...
  "$HOME/.iterami/repositories/files/Config/GarrysMod/garrysmod/autoexec.cfg"
  "$HOME/.iterami/repositories/files/Config/Gothic/3/ge3.ini"
  "$HOME/.iterami/repositories/files/Config/Half-Life/hl2/autoexec.cfg"
  "$HOME/.iterami/repositories/files/Config/Half-Life/episodic/autoexec.cfg"
  "$HOME/.iterami/repositories/files/Config/Half-Life/ep2/autoexec.cfg"
  "$HOME/.iterami/repositories/files/Config/Half-Life/lostcoast/autoexec.cfg"
  "$HOME/.iterami/repositories/files/Config/Might-and-Magic/Dark-Messiah/autoexec.cfg"
  "$HOME/.iterami/repositories/files/Config/Portal/portal/autoexec.cfg"
  "$HOME/.iterami/repositories/files/Config/Portal/portal2/autoexec.cfg"
