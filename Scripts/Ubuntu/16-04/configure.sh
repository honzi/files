...
sudo apt-get remove fonts-kacst-one
sudo apt-get remove fonts-khmeros-core
sudo apt-get remove fonts-lao
sudo apt-get remove fonts-lklug-sinhala
...
sudo apt-get remove fonts-sil-padauk
sudo apt-get remove fonts-takao-pgothic
sudo apt-get remove fonts-tibetan-machine
sudo apt-get remove fonts-tlwg-garuda
sudo apt-get remove fonts-tlwg-garuda-ttf
sudo apt-get remove fonts-tlwg-kinnari
sudo apt-get remove fonts-tlwg-kinnari-ttf
sudo apt-get remove fonts-tlwg-laksaman
sudo apt-get remove fonts-tlwg-laksaman-ttf
sudo apt-get remove fonts-tlwg-loma
sudo apt-get remove fonts-tlwg-loma-ttf
sudo apt-get remove fonts-tlwg-mono
sudo apt-get remove fonts-tlwg-mono-ttf
sudo apt-get remove fonts-tlwg-norasi
sudo apt-get remove fonts-tlwg-norasi-ttf
sudo apt-get remove fonts-tlwg-purisa
sudo apt-get remove fonts-tlwg-purisa-ttf
sudo apt-get remove fonts-tlwg-sawasdee
sudo apt-get remove fonts-tlwg-sawasdee-ttf
sudo apt-get remove fonts-tlwg-typewriter
sudo apt-get remove fonts-tlwg-typewriter-ttf
sudo apt-get remove fonts-tlwg-typist
sudo apt-get remove fonts-tlwg-typist-ttf
sudo apt-get remove fonts-tlwg-typo
sudo apt-get remove fonts-tlwg-typo-ttf
sudo apt-get remove fonts-tlwg-umpush
sudo apt-get remove fonts-tlwg-umpush-ttf
sudo apt-get remove fonts-tlwg-waree
sudo apt-get remove fonts-tlwg-waree-ttf
